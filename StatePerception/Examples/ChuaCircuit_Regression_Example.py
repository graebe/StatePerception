...
I_train[100:250] = 0
data_train = [[[X_train],[Y_train],[I_train]],[[X_train],[Y_train],[I_train]]]
X_val = X[8000:9000,:]
Y_val = Y[8000:9000,:]
...
spp.plot_scatter(tensor_axis_1=['X',0],tensor_axis_2=['X',0],signal_axis_1=0,signal_axis_2=1,alpha=0.1)
spp.plot_heatmap(tensor_axis_1=['X',0],tensor_axis_2=['X',0],signal_axis_1=0,signal_axis_2=1,bins=(100,100))
...
# Fit Neural Network
sptrainer.fit_model(timesteps=100,batch_size=128,epochs=1000,discard_invalid='last timestep')
